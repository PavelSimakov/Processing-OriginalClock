class SecondAndMinutClocksHand {
  int cenX;
  int cenY;
  int timeSegment;
  ...
  SecondAndMinutClocksHand(int tempCX, int tempCY, int TempTimeSegment, float tempRadiusClockHand, int tempColorTime[], float tempTimeWeight)  {
    cenX = tempCX;
    cenY = tempCY;
